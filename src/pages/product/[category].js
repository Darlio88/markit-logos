...
const Product = () => {
  ...
  // const service=services.find(service=>service.name.toLowerCase()===category.toLowerCase())
  const [ service, setServices]= useState(!category?null:services.find(service=>service.name.toLowerCase()===category.toLowerCase()))
...
useEffect(()=>{
  if(category) setFilterProducts(products.filter((item)=>item.category==category))
  if(category) {
    
    let newService=services.find(service=>{
      console.log(service.name.toLowerCase(),category.toLowerCase())
      return service.name.toLowerCase()==category.toLowerCase()
    })
    console.log(newService, category)
  ...
  return (
    <>
      ...
      <BgShape />
      {/* bg shape area end */}
      <DescriptionHeader service={service} />
      <DescriptionArea  service={service} />
