...
const Brochures =()=>{
    ...
    return (
        <>
         <SEO pageTitle={"Brochures"} />
         <Header />
         {/* upper section containing service title */}
         <section className="brochures__new__section-one">
         ...
         <section className="brochures__new__section-two" style={{background:"#FFFFFF"}}>
            {/* left */}
            <div>
...
{/* lower section containing vault */}
         <section className="brochures__new__section-three">
...
{/* section three content */}
         <section className="brochures__new__section-four">
            {/* left */}
            <div>
                <h1>Creating Beautiful brochures</h1>
                <p>Beautiful brochures don't happen by accident. Creating a beautiful Flyer is both a science and an artform. It requires research, analytics and proven marketing methodologies coupled with creative thinking, artistic talent and design sensibilities.</p>
                <p>
         ...
         {/* section four */}
         <section className="brochures__new__section-five">
            {/* right side containing an image */}
         <div>
         <Image src={computerPhoto}  height="400" width="500" alt="" />
         </div>
         ...
         <div>
            ...
            <p>
                Your brochures are not your logos
                It's surprising how many people don't realize that their brochures is NOT their brand. A brand goes far beyond its logo. A logo design might even change over time, but the brand itself should remain relatively unchanged. Your brand is the message and attributes of the personality of your business, product or service and the promise it makes and delivers to the customer.
                </p>
                <p>
                Even without a brochures, a white and green paper coffee cup is instantly associated with the Starbucks brand. Moreover, the brand attributes they have carefully selected and intentionally earned are subconsciously identifiable by most of the world's population.
                </p>
                <p>
                Although your brochures is not your brand, it plays a significant role in your brand as an identifier. As with other aspects of your web and marketing, the logo itself should be developed following the guidelines set forth in your Brand Positioning & Strategy directives.
                </p>
         </div>
