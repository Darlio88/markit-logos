   ...
   const contactInfoData = [
      {
         ...
         link:"https://goo.gl/maps/2qMuheNFDyeLhhNT8"
      },
      {
         id: 2,
         ...
         link:"mailto:workazu.com@gmail.com"
      },
      {
         id: 3,
               ...
               <div className="row">
                  {
                     contactInfoData.map(info => {
                        return <a href={`${info.link}`} key={info.id} className="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
