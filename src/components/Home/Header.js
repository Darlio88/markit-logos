                  ...
                  <div className="row align-items-center">
                     <div className="col-xxl-4 col-xl-2 col-lg-2 col-md-4 col-6">
                        <div className="logo">
                           <Link href='/'>
                              {/* <a> */}
                              <Image src="/assets/img/logo/workazi-final-logo.png" height="50" width="120" alt="logo" />

                                 {/* <img src="assets/img/logo/workazi-final-logo.png" alt="logo" /> */}
                                 {/* <img src="assets/img/logo/workazi-final-logo-white.png" alt="logo" /> */}
                             {/* </a> */}
                           </Link> 
                        </div>
                     </div>
                     <div className="col-xxl-8 col-xl-8 col-lg-8 d-none d-lg-block">
                        <div className="main-menu">
                           <nav id="mobile-menu">
                              ...
                              {/* <li><Link href="/"><a>Get a Service</a></Link></li> */}
